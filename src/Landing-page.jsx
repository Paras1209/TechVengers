				...
				<section className="hero">
					<div className="hero-content">
						...
						<div className="cta-buttons" data-aos="zoom-out-up">
							<button onClick={()=>{navigate('/login')}} style={{ backgroundColor: "#4DAF50" }}>Login</button>
							<button onClick={()=>{navigate('/login')}} >Sign Up</button>
						</div>
						<p>
							Connecting students, alumni for a brighter
							future.
						</p>
					</div>
				...
				<div className="contact-section">
					...
					<div className="contact-info">
						<div className="contact-message">
							...
							<a href="mailto:connect@scholarconnect.com">connect@scholarconnect.com</a>
						</div>
