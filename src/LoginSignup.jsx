		...
		<div className={`wrapper ${isActive ? "active" : ""}`}>
			...
			<div className="form-box login">
				...
				<form action="#">
					...
					<button onClick={() => { navigate('/dashboard') }}type="submit" className="btn animation" style={{ "--i": 3, "--j": 24 }}>
						Login
					</button>
			...
			<div className="form-box register">
				...
				<form action="#">
					...
					<button type="submit" className="btn animation" style={{ "--i": 21, "--j": 4 }} onClick={()=>{navigate('/register')}} >
						Sign Up
					</button>
