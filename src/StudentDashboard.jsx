...
// 				<div className="logo">Gyan Setu</div>
...
// 					<span className="tooltip-text" onClick={()=>{navigate('/forum')}} >Forums</span>
// 				</div>
// 				<div className="icon-tooltip">
// 					<FontAwesomeIcon icon={faVideo} />
// 					<span className="tooltip-text" onClick={()=>{navigate('/webinar')}} >Webinar</span>
// 				</div>
// 				<div className="icon-tooltip">
// 					<FontAwesomeIcon icon={faCalendar} />
...
// 									<p>
// 										<strong>Jane Doe</strong>: Leading AI Research at XYZ Corp
// 									</p>
// 								</div>
// 								<div className="carousel-item">
// 									<img src="https://via.placeholder.com/150" alt="Alumni" />
// 									<p>
// 										<strong>John Smith</strong>: CTO at ABC Ltd.
// 									</p>
// 								</div>
// 							</div>
// 						</div>
	...
	return (
		<div>
			...
			>
				...
				<div className="icon-tooltip" onClick={()=>{navigate('/webinar')}} >
					<FontAwesomeIcon icon={faVideo} />
